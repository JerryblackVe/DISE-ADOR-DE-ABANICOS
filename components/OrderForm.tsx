  ...
  return (
    <div className="fixed inset-0 bg-white dark:bg-gray-900 z-50 overflow-y-auto transition-colors">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <button onClick={onCancel} className="flex items-center text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white mb-8">
          <ArrowLeft size={20} className="mr-2" /> Volver al Editor
        </button>

        <div className="grid md:grid-cols-2 gap-12">
          {/* Summary */}
          <div>
            <h2 className="text-2xl font-serif font-bold text-gray-900 dark:text-white mb-6">Resumen del Diseño</h2>
          ...
          {/* Form */}
          <div>
             <h2 className="text-2xl font-serif font-bold text-gray-900 dark:text-white mb-6">Finalizar Pedido</h2>
             <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none"
                  />
                ...
                <button 
                  type="submit"
                  className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center"
                >
